...
IUSE="connman doc geonames gps gsmloc gtk hostip manual networkmanager nominatim plazes skyhook static-libs yahoo-geo"
...
DEPEND="${RDEPEND}
	doc? ( dev-util/gtk-doc dev-util/gtk-doc-am )
	virtual/pkgconfig"
