...
IUSE="bindist firejail +gmp-autoupdate gtk3 hardened hwaccel jack nsplugin pgo qt5 rust selinux test"
...
PROFILE_EOF
	...
	if use firejail; then
		...
		newins "${FILESDIR}/${PN}-firejail" ${PN}
		fperms 0755 "${MOZILLA_FIVE_HOME}/${PN}"
	else
